...
try:
    ...
    # arduino = serial.Serial('/dev/cu.usbmodem111301')
...
def handle_message(data):
    ...
    if state_dict["ringing"] == False and sound_type != "Background Noise" and accuracy >= params["accuracy_range"]: 
        # add accuracy threshold + threshold in database
